...
function NavIcon({ icon }: { icon: (typeof links)[number]["icon"] }) {
  ...
  return (
    <svg {...baseProps}>
      <path d="M12 3.8a2.2 2.2 0 0 1 2.2 2.2 2.2 2.2 0 0 0 1.6 2.1 2.2 2.2 0 0 1 2.9 2.6 2.2 2.2 0 0 0-.8 2.5 2.2 2.2 0 0 1-1.3 3.5 2.2 2.2 0 0 0-1.6 2 2.2 2.2 0 0 1-3.8 1.4 2.2 2.2 0 0 0-2.6 0 2.2 2.2 0 0 1-3.8-1.4 2.2 2.2 0 0 0-1.6-2A2.2 2.2 0 0 1 2 15.7a2.2 2.2 0 0 0 .8-2.5 2.2 2.2 0 0 1 2.9-2.6 2.2 2.2 0 0 0 1.6-2.1A2.2 2.2 0 0 1 12 3.8Z" />
